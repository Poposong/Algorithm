...
### 출력 
 ...
 #### 부모의 노드를 호출하기 위해서 단방향이 아닌 양방향으로 그래프의 간선을 생성하고 탐색해야한다.
 #### ex) 1 2 3 ( 1->2로 3이라는 가중치를 가지고 있다면 1->2(3), 2->1(3) 으로 두 가지 경우로 나눠진다)
 
 ![image](https://user-images.githubusercontent.com/81174840/219069800-b0e0ae3f-939b-4bbb-985b-2e1bf2dd7074.png)
